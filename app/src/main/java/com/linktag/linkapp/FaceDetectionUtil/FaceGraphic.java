...
public class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    private static final float STATUS_TEXT_SIZE = 100.0f;
...
//        if (FirebaseVisionFaceLandmark.LEFT_EAR == 3 && FirebaseVisionFaceLandmark.RIGHT_EAR == 9) {
////                    if (face.getBoundingBox().left >= 110 && face.getBoundingBox().left <= 280) {
//            if (FirebaseVisionFaceLandmark.LEFT_EYE == 4 && FirebaseVisionFaceLandmark.RIGHT_EYE == 10) {
//                if (FirebaseVisionFaceLandmark.NOSE_BASE == 6 && FirebaseVisionFaceLandmark.LEFT_CHEEK == 1 && FirebaseVisionFaceLandmark.RIGHT_CHEEK == 7) {
//                    if (FirebaseVisionFaceLandmark.MOUTH_BOTTOM == 0 && FirebaseVisionFaceLandmark.MOUTH_LEFT == 5 && FirebaseVisionFaceLandmark.MOUTH_RIGHT == 11) {
//
//                            ((Main) Main.mContext).onViewClicked();    // #007
//
//
//                    }
//                }
