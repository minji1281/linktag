...
import com.linktag.linkapp.FaceCenterCircleView.FaceCenterCrop.FaceCenterCropListener;
import com.linktag.linkapp.R;
import com.linktag.linkapp.Utils.Imageutils;
import com.linktag.linkapp.Utils.Imageutils.ImageAttachmentListener;
import com.linktag.linkapp.Utils.ProgressBarUtil.ProgressBarData;
import com.linktag.linkapp.Utils.ProgressBarUtil.ProgressUtils;
...
import static com.linktag.linkapp.Utils.Imageutils.GALEERY_REQUEST_CODE;
import static com.linktag.linkapp.Utils.Imageutils.SCANNER_REQUEST_CODE;
        ...
        if (faceCenterCropListener == null)
            faceCenterCropListener = new FaceCenterCropListener() {
                ...
                public void onTransform(Bitmap updatedBitmap) {
                    ...
                    Toast.makeText(GPSInfo.this, "We detected a face", Toast.LENGTH_SHORT).show();
                    progressUtils.dismissDialog();
                }

                @Override
                public void onFailure() {
                    Toast.makeText(GPSInfo.this, "No face was detected", Toast.LENGTH_SHORT).show();
                    progressUtils.dismissDialog();
