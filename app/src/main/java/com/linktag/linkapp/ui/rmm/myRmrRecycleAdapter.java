...
public class myRmrRecycleAdapter extends RecyclerView.Adapter<myRmrRecycleAdapter.ViewHolder> {
...
//    }
    ...
    @NonNull
    @Override
    public myRmrRecycleAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = mInflater.inflate(R.layout.listitem_find_my_rmr
                , parent, false);
        myRmrRecycleAdapter.ViewHolder viewHolder = new myRmrRecycleAdapter.ViewHolder(view);
